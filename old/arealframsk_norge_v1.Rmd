...
Naturregnskapsprosjekt, 4. November 2025
...
library(sf)
# filepath to the wd
wfp<-file.path("C:","Users","muk",
               paste0("OneDrive - Statistisk sentralbyr","\U00E5"),
               "Projects","Naturregnskap","arealframskrivninger","analysis")
...
write.csv(dfd,file.path(wfp,"results","calculationdf.csv"))
```
